          ...
          <ExpandContainer>
            ...
            {info === 'connect' && (
              <Text>
                ...
                To connect to the server online you need to create a user on
                this website and use the same user credentials to set up the
                game.
                <Header h3>Registering</Header>
                You register by using the form on the right side of the
                frontpage of elma.online. After registering you need to confirm
                your email before your account is enabled. Click the link in the
                email you will get.
                ...
                <List>
                  <li>
                    When it opens go to any level and you can see system
                    messages in the top of the screen, it should imediately
                    connect and say &quot;connected to the server&quot;
                  </li>
                  <li>
            ...
            {info === 'battles' && (
              <Text>
                ...
                To participate in a battle you need to download the level and
                play it.
                <List>
                  <li>
                  ...
                  <li>
                    Play the level untill the timer runs out and attempt to get
