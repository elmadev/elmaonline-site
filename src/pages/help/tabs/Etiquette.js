      ...
      <Text>
        ...
        <ul>
          ...
          <li>
            ...
            <ul>
              <li>
                Survivor battles should not include parts which allow you to
                stop completely.
              </li>
              <li>
            ...
            <li>
              ...
              there are no strict rules. In general, it&#39;s encouraged to
              start battles for long enough to be able to get a good grasp of
              the level but not too long to get bored with it.
            </li>
            <li>
              Speedloops, i.e. levels mainly consisting of smooth loops with a
              lot of speed, are generally considered boring and unwanted.
            </li>
          </li>
        </ul>
      </Text>
